...
#'
#' @export
hemorrhagesModel <- function(connectionDetails,
                         cdmDatabaseSchema,
  ...
  warning('Hemorrhages includes a Genetic Factors predictor that is not possible to include in this version')

  modelName <- 'hemorrhages'

  ParallelLogger::logInfo('Extracting hemorrhages settings')
